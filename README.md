# FlowFI - Image Parameter Design Update v0.5.0.1
...
pip install flowkit
conda install -c conda-forge numpy=1.26 pandas scipy opencv pyqt scikit-learn scikit-learn-extra matplotlib leidenalg tifffile scikit-image minisom
```
